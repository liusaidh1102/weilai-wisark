...
public class MinioClientProviderImpl implements MinioClientProvider {
    ...
    private volatile com.kangaroohy.minio.service.client.ExtendMinioAsyncClient minioAsyncClient;

    private volatile MinioClient minioClient;

    @Override
    public com.kangaroohy.minio.service.client.ExtendMinioAsyncClient getAsyncClient(String endpoint, String accessKey, String secretKey) {
