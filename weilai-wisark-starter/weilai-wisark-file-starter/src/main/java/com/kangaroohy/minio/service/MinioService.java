...
public class MinioService {
    ...
    private final com.kangaroohy.minio.service.client.ExtendMinioAsyncClient minioAsyncClient;
    ...
    public Map<String, String> getPresignedPostFormData(String bucketName, String path, String fileName, ZonedDateTime time) throws MinioServiceException {
        ...
        String key = com.kangaroohy.minio.constant.MinioConstant.URI_DELIMITER + CustomUtil.getPath(path) + fileName;
        ...
        try {
            ...
            map1.put("key", key);
            map1.put("host", properties.getEndpoint() + com.kangaroohy.minio.constant.MinioConstant.URI_DELIMITER + bucketName);
            return map1;
        } catch (ErrorResponseException | IOException | InsufficientDataException
                 | InternalException | InvalidKeyException | InvalidResponseException
                 | NoSuchAlgorithmException | XmlParserException | ServerException e) {
     ...
     * @throws MinioException
     */
    public com.kangaroohy.minio.entity.MultiPartUploadInfo getPresignedMultipartUploadUrls(String objectName, Integer partSize) throws MinioServiceException {
     ...
     * @throws MinioException
     */
    public com.kangaroohy.minio.entity.MultiPartUploadInfo getPresignedMultipartUploadUrls(String objectName, Integer partSize, String contentType) throws MinioServiceException {
     ...
     * @throws MinioException
     */
    public com.kangaroohy.minio.entity.MultiPartUploadInfo getPresignedMultipartUploadUrls(String bucketName, String objectName, Integer partSize) throws MinioServiceException {
     ...
     * @throws MinioException
     */
    public com.kangaroohy.minio.entity.MultiPartUploadInfo getPresignedMultipartUploadUrls(String bucketName, String objectName, Integer partSize, String contentType) throws MinioServiceException {
     ...
     * @throws MinioException
     */
    public com.kangaroohy.minio.entity.MultiPartUploadInfo getPresignedMultipartUploadUrls(String bucketName, String path, String objectName, Integer partSize) throws MinioServiceException {
     ...
     * @throws MinioException
     */
    public com.kangaroohy.minio.entity.MultiPartUploadInfo getPresignedMultipartUploadUrls(String bucketName, String path, String objectName, Integer partSize, String contentType) throws MinioServiceException {
     ...
     * @throws MinioException
     */
    public com.kangaroohy.minio.entity.MultiPartUploadInfo getPresignedMultipartUploadUrls(String bucketName, String path, String objectName, Integer partSize, String contentType, Integer time) throws MinioServiceException {
     ...
     * @throws MinioException
     */
    public com.kangaroohy.minio.entity.MultiPartUploadInfo getPresignedMultipartUploadUrls(String bucketName, String path, String objectName, Integer partSize, String contentType, Integer time, TimeUnit timeUnit) throws MinioServiceException {
        String uploadId = "";
        ...
        return com.kangaroohy.minio.entity.MultiPartUploadInfo.builder()
                .uploadId(uploadId)
                .fileName(objectName)
     ...
     * @return
     */
    public com.kangaroohy.minio.entity.MultiPartUploadInfo getPresignedMultipartUploadUrlsByPartNumbers(String uploadId, String objectName, List<Integer> partNumbers) throws MinioServiceException {
     ...
     * @return
     */
    public com.kangaroohy.minio.entity.MultiPartUploadInfo getPresignedMultipartUploadUrlsByPartNumbers(String uploadId, String bucketName, String objectName, List<Integer> partNumbers) throws MinioServiceException {
     ...
     * @return
     */
    public com.kangaroohy.minio.entity.MultiPartUploadInfo getPresignedMultipartUploadUrlsByPartNumbers(String uploadId, String bucketName, String path, String objectName, List<Integer> partNumbers) throws MinioServiceException {
     ...
     * @return
     */
    public com.kangaroohy.minio.entity.MultiPartUploadInfo getPresignedMultipartUploadUrlsByPartNumbers(String uploadId, String bucketName, String path, String objectName, List<Integer> partNumbers, Integer time) throws MinioServiceException {
     ...
     * @return
     */
    public com.kangaroohy.minio.entity.MultiPartUploadInfo getPresignedMultipartUploadUrlsByPartNumbers(String uploadId, String bucketName, String path, String objectName, List<Integer> partNumbers, Integer time, TimeUnit timeUnit) throws MinioServiceException {
        List<String> partUrlList = new ArrayList<>();
        try {
            objectName = (StringUtils.hasText(path) ? CustomUtil.getPath(path) : "") + CustomUtil.getObjectName(objectName);
            Map<String, String> paramsMap = new HashMap<>(2);
    ...
    public String getDatePath() {
        return String.join(com.kangaroohy.minio.constant.MinioConstant.URI_DELIMITER, CustomUtil.getDateFolder());
    }
    ...
    public String gatewayUrl(String bucket, String finalPath) {
        finalPath = finalPath.startsWith(com.kangaroohy.minio.constant.MinioConstant.URI_DELIMITER) ? finalPath.substring(finalPath.indexOf(com.kangaroohy.minio.constant.MinioConstant.URI_DELIMITER) + 1) : finalPath;
        return getAddress(properties.getEndpoint() + com.kangaroohy.minio.constant.MinioConstant.URI_DELIMITER + bucket + MinioConstant.URI_DELIMITER + finalPath);
    }
